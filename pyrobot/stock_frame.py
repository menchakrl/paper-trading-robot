...
class StockFrame():
    def __init__(self, data: list[dict]) -> None:
        ...
        # groupby with a rolling window. This is helpful for indicator calculations
        # this will help a bit with performance since these calculations will be done
    ...
    def add_rows(self, data: dict) -> None:
        ...
        for symbol in data:
            ...
            # Add the row
            # Note: here self.frame is using the @property frame method defined above
